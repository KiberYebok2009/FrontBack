...
button.onclick = function(){
    ...
    if (image.classList.contains("logo")){
        ...
        cont.style.border = "solid black calc(var(--font-size)*0.17)";
        empicon.style.border = "solid black calc(var(--font-size)*0.17)";
        for (var i = 0; i < product.length; ++i) {
        ...
        cont.style.border = "solid white calc(var(--font-size)*0.17)";
        empicon.style.border = "solid white calc(var(--font-size)*0.17)";
        for (var i = 0; i < product.length; ++i) {
